// Package orders is a fixture that logs from a file under an internal/
// directory named service.go. Both the directory and the file name were on the
// removed attribution denylist.
package orders
